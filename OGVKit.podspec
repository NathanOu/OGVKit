Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/NathanOu/OGVKit.git"
  ...
  s.source       = { :git => "https://github.com/NathanOu/OGVKit.git",
                     :tag => s.version,
                     :submodules => true }
  ...
  s.subspec "OggDemuxer" do |soggdemuxer|
    ...
    soggdemuxer.dependency 'liboggz', :tag => '1.2.0-1', :git => 'https://gitlab.xiph.org/xiph/liboggz'
